...
##' @param title The name of the channel. It's how people refer to your
...
##'   specify it as an empty string \code{""} so that the result will be
##'   printed to the standard output connection, the console unless redirected
##'   by 'sink'.
##' 
##' Note the order of items in the CSV file: newer items are added to the end
##'   of the file. But this order will be \emph{reversed} in the RSS file!
