...
#' @return A list with components \item{text.tidyThe parsed code as a character
#'   vector.} \item{text.maskThe code containing comments, which are masked in
#'   assignments.} \item{begin.comment, end.comment identifiers used to mark
#'   the comments }
#' 
