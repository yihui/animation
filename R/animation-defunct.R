...
##' @aliases animation-defunct highlight.def write.rss
...
highlight.def <- function(file = "r.lang") {
    .Defunct('http://yihui.name/en/2007/09/r-language-definition-file-for-highlight/')
}
...
write.rss <- function(file = "feed.xml", entry = "rss.csv",
    ...
    maxitem = 10, ...) {
    .Defunct('https://github.com/yihui/animation/raw/1650902e43fe283d4fd0cea8f559e4e5187d60fe/R/write.rss.R')
}
