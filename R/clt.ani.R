...
#' is plotted as the sample size \eqn{n} increases, besides, the p-values from
#' the normality test \code{\link{shapiro.test}} are computed for each \eqn{n}
...
#' 
#' @param obs the number of sample points to be generated from the distribution
