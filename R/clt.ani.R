...
#' normality test \code{\link[stats]{shapiro.test}} are computed for each
...
#'   P-values.
#' @param mat,widths,heights arguments passed to \code{\link[graphics]{layout}}
#'   to set the layout of the two graphs.
