...
#' @return A list with components \item{cluster A vector of integers indicating
#'   the cluster to which each point is allocated.} \item{centers A matrix of
#'   cluster centers.}
#' @note This function is only for demonstration purpose. For practical
#'   applications please refer to \code{\link{kmeans}}.
#' 
#' Note that \code{nmax} is defined as the maximum number of iterations in such
#'   a sense: an iteration includes the process of computing distances,
