...
ani.stop = function() {
    ...
    if (isTRUE(ani.options("verbose")))
        footer = paste("<div class=\"footer\">Created by R package \"<a href=\"http://cran.r-project.org/package=animation\" target=\"_blank\">animation ", ifelse(getRversion() >= '2.12.0', utils::packageVersion("animation"), packageDescription('animation', fields = 'Version')), "</a>\" written by <a href=\"http://yihui.name/\" target=\"_blank\">Yihui XIE</a>.<br>",
            Sys.time(), "</div>", sep = "")
