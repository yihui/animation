...
#' evaluated and recorded by a grahpics device (typically
...
#' is provided. And the final PDF output will be opened with the PDF viewer set
#' in \code{getOption("pdfviewer")} if \code{ani.options("autobrowse") == TRUE}.
