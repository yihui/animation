...
#' 
#' Briefly speaking, the process of cross-validation is just to split the whole
#' data set into several parts and select one part as the test set and the rest
#' parts as the training set.
#' 
...
#' @param col a character vector of length 3 specifying the colors of: the
#'   rectangle representing the test set, the points of the test set, and
