...
#' \eqn{k} shortest distances and the corresponding training set points \item{}
#' vote for the result (find the maximum in the table for the true
#' classifications) }
#' 
...
#'   etc.
#' 
#' If either one of \code{train} and \code{test} is missing, there'll be random
#'   matrices prepared for them. (It's the same for \code{cl}.)
