...
##' plots
##' @param replay.cur whether to replay the current plot (we can set
##' both \code{reset} and \code{replay.cur} to \code{TRUE} so that
##' low-level plotting changes can be captured by off-screen graphics
