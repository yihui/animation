...
#' This function has provided an illustration of the process of finding out the
...
#' \itemize{ \item{} For the number of features \eqn{g = 1, 2, \cdots, g_{max}g
#' = 1, 2, ..., gmax}, choose \eqn{g} features that have the largest
