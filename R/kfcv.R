...
##' ...), otherwise the remainder will be allocated to each group as
##' `uniformly' as possible, and at last these sample sizes will be
##' permuted randomly.
##' @param k number of groups.
##' @param N total sample size.
##' @return A vector of length \code{k} containing \eqn{k} sample
##' sizes.
