##' Visual illusions: Scintillating grid illusion and Hermann grid
##' illusion
##'
##' The two most common types of grid illusions are Hermann grid
##' illusions and Scintillating grid illusions. This function provides
##' illustrations for both illusions.
##'
...
##' @param type type of illusions: \code{'s'} for Scintillating grid
##' illusions and \code{'h'} for Hermann grid illusions
##' @return \code{NULL}
...
##'     col = "white")
vi.grid.illusion = function(nrow = 8, ncol = 8, lwd = 8,
