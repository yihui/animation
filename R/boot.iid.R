...
#' illustrate the results of sampling, and a histogram to show the distribution
...
#' bootstrap samples \emph{with} replacement.
#' 
...
#' @return A list containing \item{t0 The observed value of 'statistic' applied
#'   to 'x'.} \item{tstar Bootstrap versions of the 'statistic'.}
#' @author Yihui Xie
