...
#' distribution and average the values of \eqn{f(x_i)}. As \eqn{n}
#' goes to infinity, the sample mean will approach to the expectation
#' of \eqn{f(X)} by Law of Large Numbers.
#'
#' The height of the \eqn{i}-th rectangle in the animation is
#' \eqn{f(x_i)} and the width is \eqn{1/n}, so the total area of all
#' the rectangles is \eqn{\sum f(x_i) 1/n}, which is just the sample
#' mean. We can compare the area of rectangles to the curve to see
#' how close is the area to the real integral.
