...
#' computed for data points inside the ``windows'' during the process of
#' moving.
#' 
...
#' @param conf a positive number: the confidence intervals are computed as [ar1
#'   - conf*s.e., ar1 + conf*s.e.]
