...
#' regression using rectangles to denote the ``windows'' and move
#' them, and the corresponding AR(1) coefficients as long as rough
#' confidence intervals are computed for data points inside the
#' ``windows'' during the process of moving.
#'
