...
#' bisection algorithm is then applied recursively to the sub-interval where
...
#'   if it is equal to \code{ani.options('nmax')}, it's quite likely that the
#'   root is not reliable because the maximum number of iterations has been
#'   reached}
