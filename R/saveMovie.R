...
#' images based on \code{expr}, then makes use of the command \code{convert} in
#' `ImageMagick' to convert these images to a single animated movie (in formats
#' such as GIF and MPG, etc).
#' 
...
#' @param ani.first an expression to be evaluated before plotting (this will be
#'   useful to set graphical parameters in advance, e.g. \code{ani.first =
#'   par(pch = 20)}
