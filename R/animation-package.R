...
#' statistics; other kinds of output such as Flash (SWF) or GIF animations or
#' PDF animations are also available if required software packages have been
...
#' numeric vector: the period (1 - 4)} \item{\code{realx}}{a numeric vector: the
#' x-axis location} \item{\code{realy}}{a numeric vector: the y-axis location}
#' \item{\code{result}}{a factor with levels \code{made} and \code{missed}}
#' \item{\code{team}}{a factor with levels \code{CLE}, \code{LAL} and
#' \code{OFF}} }
