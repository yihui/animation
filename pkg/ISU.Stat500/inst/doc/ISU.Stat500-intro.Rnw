...
in Fall 2009. We warmly welcome comments on this document.%
} \and Hui Lin %
...
We have also collected some functions which are of no direct interest
to statistical methods, but they might be helpful for us to save time.
