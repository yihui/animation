...
jumpingHorse <- function(n, size = 8) {
    ...
    shape <- data.frame(x = c(0.486, 0.47, 0.402, 0.228, 0.128, 
        ...
        0.664, 0.776, 0.854, 0.842, 0.722, 0.57), y = c(0.952, 
        0.838, 0.79, 0.64, 0.594, 0.502, 0.462, 0.506, 0.538, 
        0.4, 0.174, 0.004, 0.004, 0.174, 0.174, 0.374, 0.596, 
        0.776, 0.85))
    ...
    for (i in 1:n) {
        ...
        rect(pos[1] - 1, pos[2] - 1, pos[1], pos[2], col = ifelse(sum(pos)%%2 == 
            0, "black", "cornsilk"), border = "black")
